...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\draw [->] (1,4.25) to[out=10,in=-270] (2.25,3.25);
	\end{tikzpicture}
	\flushright \footnotesize Fonte: \citeauthor{marcio:jogos} \hspace{35pt}
\end{figure}
...
Na tabela acima temos então que $S_{0}$ é o valor inicial obtido, referente a distância em km que os times irão percorrer durante a realização do campeonato, e $S_{k}$ o valor da distância prevista após a aplicação do método heurístico. 
